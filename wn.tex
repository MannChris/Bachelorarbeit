...
\end{equation}
Um das zu tun, werden die Spannbäume von $W_{n+1}$ in drei verschiedene Klassen einteilen:\\%%?Klassen hier richtiger Begriff?
...
Wir können jetzt - zum Beispiel durch vollständige Induktion über $n \in \mathbb{N}$ - unsere Formel %%Formel von oben
verifizieren.\\
