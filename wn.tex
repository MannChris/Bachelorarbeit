...
%\begin{figure}[h]
    \begin{minipage}{0.45\textwidth}
        \centering
        \includegraphics[width=1\textwidth]{klasse1.png}
 ...
 \label{klasse1} %caption vor label unbedingt
    ...
    \begin{minipage}{0.45\textwidth}
        \centering
        \includegraphics[width=1\textwidth]{klasse2.png}
...
Nun zeigen wir, dass $|M_{n+1}|=2|M_n|+b_n$ ist; wir erinnern uns dabei an dieser Stelle daran, dass wir die Knoten beliebig umnummerieren können. In $M_{n+1}$ sind also die Spannbäume des Graphen aus Abbildung~\ref{mn1}.
\begin{figure}[H]
  \centering
...
\rightskip=20pt
\noindent
Die Erste bilden diejenigen, in denen die Kante $v_{n+1}z$ enthalten ist; Wie wir in der Grafik~\ref{mn2} erkennen können, sind das soviele, wie in $M_n$.\\
Die Zweite besteht aus denen, die die Kante $v_nv_{n+1}$ enthalten; In Abbildung~\ref{mn3} sehen wir, dass das auch $|M|$ Stück sind.\\
Die Dritte beinhaltet die, die weder die Kante $v_{n+1}z$ noch die Kante $v_nv_{n+1}$ enthalten; Das sind nach Definition genau $b_n$ viele.\\
\par
\endgroup
\begin{figure}[H]
    \centering
 ...
 \label{mn3} %caption vor label unbedingt
    \end{minipage}
\end{figure}
Daraus schließen wir also $|M_{n+1}|=2|M_n|+b_n$.\\
Wir sehen leicht, dass $\mathit{k}\left(F_2\right) = |M_2|$ und $a_2=b_2$; daraus schließen wir, dass die Anzahl der Spannbäume in Klasse 3 gleich $\mathit{k}\left(F_{n}\right)$ ist, was wir zeigen wollten.
