...
\todo[inline, color=yellow]{formellastige Definitionen im Fall von Matrizen sinnvoller?(Übersichtlichkeit?)}
...
\todo[inline, color=yellow]{Stand jetzt werde ich die Definitionen als solche hervorheben, Notation jedoch im Fließtext unterbringen, passt das so?}
