...
\todo[inline, color=yellow]{formellastige Definitionen im Fall von Matrizen sinnvoller?(Übersichtlichkeit?) (Je nachdem, wie schnell ich mit dem Schreiben bin, könnte ich noch Links in die Bachelorarbeit integrieren, dauert nicht lang)}
...
\todo[inline, color=yellow]{Stand jetzt werde ich die Definitionen hervorheben, notation jedoch im Fließtext unterbringen, passt das so?}
\todo[inline]{Definition aboreszenz nicht hier!!}
